...
- M6: `20260815160000_m6_appointment_operations` — confirm / check-in / start / complete / no-show permission seeds

M6 does not rewrite M1–M5 migrations. It does not add notification event types, clinical fields, or hard-delete.
