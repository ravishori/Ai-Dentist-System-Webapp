import { handlePractitionerActivate } from "@dentalcare/application";
...
export async function POST(
  ...
  return postPractitionerCommand(request, "practitioner_activate", (input) =>
    handlePractitionerActivate(getPractitionerService(), { ...input, practitionerId }),
  );
}
