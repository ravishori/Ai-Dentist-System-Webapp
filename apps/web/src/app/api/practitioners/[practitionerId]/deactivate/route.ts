import { handlePractitionerDeactivate } from "@dentalcare/application";
...
export async function POST(
  ...
  return postPractitionerCommand(request, "practitioner_deactivate", (input) =>
    handlePractitionerDeactivate(getPractitionerService(), { ...input, practitionerId }),
  );
}
