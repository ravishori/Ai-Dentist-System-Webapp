import { handlePractitionerUpdate } from "@dentalcare/application";
...
export async function POST(
  ...
  return postPractitionerCommand(request, "practitioner_update", (input) =>
    handlePractitionerUpdate(getPractitionerService(), { ...input, practitionerId }),
  );
}
